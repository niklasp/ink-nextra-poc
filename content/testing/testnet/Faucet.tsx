  ...
  return (
    <div className="faucetContainer">
      ...
      <div className="faucetPlantContainer">
        <img
          src="/img/plantOne.svg"
          alt="illustration of a sea grass plant"
          className="faucetPlantOne"
        />
        <img
          src="/img/plantTwo.svg"
          alt="illustration of a sea plant"
          className="faucetPlantTwo"
        />
      </div>
      ...
      <div className="faucetResultContainer">
        {hash && (
          <button
            ...
            onClick={() =>
              window.open(
                `https://rococo.subscan.io/extrinsic/${hash}`,
                "_blank"
              )
            }
          >
            <div className="faucet-success-ic">
              ...
              <p className="faucet-success-cta">
