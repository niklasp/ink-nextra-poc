...
import Canary from "@/public/animations/ecosystem-canary.json";
import CuttingEdge from "@/public/animations/ecosystem-cutting-edge.json";
import Infrastructure from "@/public/animations/ecosystem-infra.json";
...
const INFRASTRUCTURE_EXAMPLES = [
  ...
  {
    icon: "/img/on-chain-contract.svg",
    title: "On-Chain Contract Verification",
  },
        ...
        <div className="max-w-biggest mx-auto">
          <div className="text-center w-full">
            <h2 className="text-5xl font-semibold font-montserrat w-full text-brand-500">
              <i className="font-bold text-black dark:text-white">Ecosystem</i>{" "}
              Grants
            </h2>
            <h3 className="p-0 m-0 mt-8 mx-auto max-w-3xl text-3xl dark:text-white/70 text-black/70">
              Ecosystem Grants are available for ink! projects that fall into
          ...
          <div className="max-w-biggest">
            <div className="flex flex-col md:flex-row items-start justify-between lg:mt-32 md:mt-16">
              ...
              <div className="md:max-w-2xl md:w-[55%]">
                <h3 className="text-base opacity-[50%] uppercase font-montserrat w-full">
                  Category 1
                </h3>
                <h2 className="text-4xl opacity-90 font-semibold font-montserrat w-full">
                  Canary DApp
                </h2>
                <p className="mt-8 dark:text-white/70 text-black/70">
                  A Canary dApp is one that could be deployed on to a value
                  bearing network, but may not necessarily be battle hardened
                  enough for serious use cases. They are meant to be a step
                  beyond simple tutorials while still being self-contained
                  enough to provide a useful reference for developers building
            ...
            <div className="flex flex-col md:flex-row items-start justify-between lg:mt-32 md:mt-16">
              ...
              <div className="md:max-w-2xl md:w-[55%]">
                ...
                <p className="mt-8 dark:text-white/70 text-black/70">
                  This category implies developing a full-stack application that
                  clearly demonstrates the advantages of ink! over other smart
                  contract languages (e.g. Solidity). In this category you
                  should focus on opening the full potential of ink!. The case
                  doesn&apos;t necessarily needs to be business oriented.
                  However it should clearly and visually demostrate superiority
                  of the ink! language.
                </p>
            ...
            <div className="flex flex-col md:flex-row items-start justify-between lg:mt-32 md:mt-16">
              ...
              <div className="md:max-w-2xl md:w-[55%]">
                ...
                <h2 className="text-5xl opacity-90 font-semibold font-montserrat w-full">
                  Infrastructure
                </h2>
                <p className="mt-8 dark:text-white/70 text-black/70">
                  The goal of this track is to improve the ink! ecosystem&apos;s
                  infrastructure and tooling. We welcome you to be innovative
                  and submit your ideas. We will prefer ideas that add
                  differentiation to the Polkadot/ink! ecosystem, rather then
                  tools that simply duplicate EVM.
                </p>
