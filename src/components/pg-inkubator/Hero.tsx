import HeroAnimation from "@/public/animations/inkubator.json";
...
export const Hero: React.FC<InkubatorHeroProps> = ({
  withLinkCTA,
  className,
}) => {
  return (
    ...
    >
      <div className="max-w-biggest mx-auto">
        <div
          className={clsx(
            "flex lg:flex-row flex-col justify-between mb-0 gap-6 px-4"
          )}
        >
          <h1
            className={clsx(
          ...
          >
            <span className="leading-tight">
              Take your{" "}
              <SquinkText className="px-4 md:h-28 h-20 align-middle" />
              <br />
              <strong className="top-[-20px] align-middle relative">
                project to <b className="text-brand-500">new</b>
                <br />
                <b className="text-brand-500 relative top-[-10px] leading-tight">
                  depths.
                </b>
              </strong>
            </span>
            ...
            <hgroup className="md:mb-10">
              <h2 className="text-2xl dark:text-white/70 mb-2">
                <span className="bg-light-background dark:bg-dark-background">
                  ink!ubator provides access to core developers and a wealth of
                  resources.
                </span>
              </h2>
              <h3 className="text-brand-500/80 font-semibold text-md italic">
                <p>
                  The first cohort has successfully concluded, and applications
                  for the next cohort are now open.
                </p>
                <p>
                  <a
                    href={
                      "https://forum.polkadot.network/t/final-report-of-ink-ubator/10120"
                    }
                  >
        ...
        <ScrollPlayer
          ...
          className="mt-0 lg:w-[70%] w-full mx-auto"
        />
      </div>
    </section>
  );
